        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          {features.map((f, i) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="group relative overflow-hidden rounded-2xl border border-white/[0.08] bg-white/[0.04] p-6 backdrop-blur"
            >
              <div className="pointer-events-none absolute -inset-1 bg-[radial-gradient(ellipse_at_top_right,rgba(255,255,255,0.12),transparent_40%)] opacity-0 blur-2xl transition-opacity group-hover:opacity-100" />
